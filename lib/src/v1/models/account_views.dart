...
class LocalUserView with _$LocalUserView {
  @modelSerde
  const factory LocalUserView({required LocalUser localUser, required Person person, required PersonAggregates counts}) = _LocalUserView;
...
class Instance with _$Instance {
  @modelSerde
  const factory Instance({required int id, required String domain, required DateTime published, DateTime? updated, String? software, String? version}) = _Instance;
