...
_$DeleteCustomEmojiImpl _$$DeleteCustomEmojiImplFromJson(
  Map<String, dynamic> json,
) => _$DeleteCustomEmojiImpl(id: (json['id'] as num).toInt());

Map<String, dynamic> _$$DeleteCustomEmojiImplToJson(
  _$DeleteCustomEmojiImpl instance,
) => <String, dynamic>{'id': instance.id};

_$ListCustomEmojisImpl _$$ListCustomEmojisImplFromJson(
  Map<String, dynamic> json,
) => _$ListCustomEmojisImpl(category: json['category'] as String?);

Map<String, dynamic> _$$ListCustomEmojisImplToJson(
  _$ListCustomEmojisImpl instance,
) => <String, dynamic>{
