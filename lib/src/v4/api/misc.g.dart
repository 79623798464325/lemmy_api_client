...
_$ResolveObjectImpl _$$ResolveObjectImplFromJson(Map<String, dynamic> json) => _$ResolveObjectImpl(q: json['q'] as String);

Map<String, dynamic> _$$ResolveObjectImplToJson(_$ResolveObjectImpl instance) => <String, dynamic>{'q': instance.q};
...
_$GetFederatedInstancesImpl _$$GetFederatedInstancesImplFromJson(Map<String, dynamic> json) => _$GetFederatedInstancesImpl(
  kind: json['kind'] == null ? null : GetFederatedInstancesKind.fromJson(json['kind']),
...
_$UploadImageImpl _$$UploadImageImplFromJson(Map<String, dynamic> json) => _$UploadImageImpl();

Map<String, dynamic> _$$UploadImageImplToJson(_$UploadImageImpl instance) => <String, dynamic>{};

_$AdminDeleteMediaImpl _$$AdminDeleteMediaImplFromJson(Map<String, dynamic> json) => _$AdminDeleteMediaImpl(filename: json['filename'] as String);

Map<String, dynamic> _$$AdminDeleteMediaImplToJson(_$AdminDeleteMediaImpl instance) => <String, dynamic>{'filename': instance.filename};

_$AdminListMediaImpl _$$AdminListMediaImplFromJson(Map<String, dynamic> json) => _$AdminListMediaImpl(limit: (json['limit'] as num?)?.toInt(), pageCursor: json['page_cursor'] as String?);

Map<String, dynamic> _$$AdminListMediaImplToJson(_$AdminListMediaImpl instance) => <String, dynamic>{
  if (instance.limit case final value?) 'limit': value,
  if (instance.pageCursor case final value?) 'page_cursor': value,
};

_$ImageHealthImpl _$$ImageHealthImplFromJson(Map<String, dynamic> json) => _$ImageHealthImpl();

Map<String, dynamic> _$$ImageHealthImplToJson(_$ImageHealthImpl instance) => <String, dynamic>{};

_$GetNodeinfoImpl _$$GetNodeinfoImplFromJson(Map<String, dynamic> json) => _$GetNodeinfoImpl();

Map<String, dynamic> _$$GetNodeinfoImplToJson(_$GetNodeinfoImpl instance) => <String, dynamic>{};
