...
_$ListPersonSavedImpl _$$ListPersonSavedImplFromJson(
...
Map<String, dynamic> _$$ListPersonSavedImplToJson(
  _$ListPersonSavedImpl instance,
) => <String, dynamic>{
...
_$ListPersonLikedImpl _$$ListPersonLikedImplFromJson(
  Map<String, dynamic> json,
) => _$ListPersonLikedImpl(
  limit: (json['limit'] as num?)?.toInt(),
  pageCursor: json['page_cursor'] as String?,
  type: json['type'] == null ? null : LikeType.fromJson(json['type']),
);

Map<String, dynamic> _$$ListPersonLikedImplToJson(
  _$ListPersonLikedImpl instance,
) => <String, dynamic>{
  if (instance.limit case final value?) 'limit': value,
  if (instance.pageCursor case final value?) 'page_cursor': value,
  if (instance.type?.toJson() case final value?) 'type': value,
...
_$ListPersonReadImpl _$$ListPersonReadImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ListPersonReadImplToJson(
  _$ListPersonReadImpl instance,
) => <String, dynamic>{
  if (instance.limit case final value?) 'limit': value,
  if (instance.pageCursor case final value?) 'page_cursor': value,
  if (instance.type?.toJson() case final value?) 'type': value,
...
_$ListPersonHiddenImpl _$$ListPersonHiddenImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ListPersonHiddenImplToJson(
  _$ListPersonHiddenImpl instance,
) => <String, dynamic>{
  if (instance.limit case final value?) 'limit': value,
  if (instance.pageCursor case final value?) 'page_cursor': value,
};
...
_$SaveUserSettingsImpl _$$SaveUserSettingsImplFromJson(
  ...
  defaultPostTimeRangeSeconds:
      (json['default_post_time_range_seconds'] as num?)?.toInt(),
...
Map<String, dynamic> _$$SaveUserSettingsImplToJson(
  ...
  if (instance.defaultListingType case final value?)
    'default_listing_type': value,
  if (instance.postListingMode case final value?) 'post_listing_mode': value,
  if (instance.defaultPostSortType case final value?)
    'default_post_sort_type': value,
  if (instance.defaultPostTimeRangeSeconds case final value?)
    'default_post_time_range_seconds': value,
  if (instance.defaultCommentSortType case final value?)
    'default_comment_sort_type': value,
  if (instance.defaultItemsPerPage case final value?)
    'default_items_per_page': value,
  ...
  if (instance.animatedImagesEnabled case final value?)
    'animated_images_enabled': value,
  ...
  if (instance.privateMessagesEnabled case final value?)
    'private_messages_enabled': value,
  if (instance.blockingKeywords case final value?) 'blocking_keywords': value,
  if (instance.autoMarkFetchedPostsAsRead case final value?)
    'auto_mark_fetched_posts_as_read': value,
  if (instance.hidePostsWithMedia case final value?)
    'hide_posts_with_media': value,
};
...
_$VerifyEmailImpl _$$VerifyEmailImplFromJson(Map<String, dynamic> json) =>
    _$VerifyEmailImpl(token: json['token'] as String);

Map<String, dynamic> _$$VerifyEmailImplToJson(_$VerifyEmailImpl instance) =>
    <String, dynamic>{'token': instance.token};

_$ResendVerificationEmailImpl _$$ResendVerificationEmailImplFromJson(
  Map<String, dynamic> json,
) => _$ResendVerificationEmailImpl(email: json['email'] as String);

Map<String, dynamic> _$$ResendVerificationEmailImplToJson(
  _$ResendVerificationEmailImpl instance,
) => <String, dynamic>{'email': instance.email};

_$GetUnreadCountsImpl _$$GetUnreadCountsImplFromJson(
  Map<String, dynamic> json,
) => _$GetUnreadCountsImpl();

Map<String, dynamic> _$$GetUnreadCountsImplToJson(
  _$GetUnreadCountsImpl instance,
) => <String, dynamic>{};

_$ResetPasswordImpl _$$ResetPasswordImplFromJson(Map<String, dynamic> json) =>
    _$ResetPasswordImpl(email: json['email'] as String);

Map<String, dynamic> _$$ResetPasswordImplToJson(_$ResetPasswordImpl instance) =>
    <String, dynamic>{'email': instance.email};

_$ChangePasswordAfterResetImpl _$$ChangePasswordAfterResetImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ChangePasswordAfterResetImplToJson(
  _$ChangePasswordAfterResetImpl instance,
) => <String, dynamic>{
