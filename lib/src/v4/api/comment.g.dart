...
_$WarnCommentImpl _$$WarnCommentImplFromJson(Map<String, dynamic> json) =>
    _$WarnCommentImpl(
      commentId: (json['comment_id'] as num).toInt(),
      reason: json['reason'] as String,
    );

Map<String, dynamic> _$$WarnCommentImplToJson(_$WarnCommentImpl instance) =>
    <String, dynamic>{
      'comment_id': instance.commentId,
...
_$GetCommentsSlimImpl _$$GetCommentsSlimImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$GetCommentsSlimImplToJson(
  _$GetCommentsSlimImpl instance,
) => <String, dynamic>{
