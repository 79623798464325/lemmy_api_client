...
_$ReportCombinedViewImpl _$$ReportCombinedViewImplFromJson(
  ...
  postReport:
      json['post_report'] == null
          ? null
          : PostReportView.fromJson(
            json['post_report'] as Map<String, dynamic>,
          ),
  commentReport:
      json['comment_report'] == null
          ? null
...
Map<String, dynamic> _$$ReportCombinedViewImplToJson(
  _$ReportCombinedViewImpl instance,
) => <String, dynamic>{
  'type': instance.type,
...
_$ListReportsResponseImpl _$$ListReportsResponseImplFromJson(
  Map<String, dynamic> json,
) => _$ListReportsResponseImpl(
  reports:
      (json['reports'] as List<dynamic>)
          .map((e) => ReportCombinedView.fromJson(e as Map<String, dynamic>))
          .toList(),
  nextPage: json['next_page'] as String?,
);

Map<String, dynamic> _$$ListReportsResponseImplToJson(
  _$ListReportsResponseImpl instance,
) => <String, dynamic>{
  'reports': instance.reports.map((e) => e.toJson()).toList(),
  'next_page': instance.nextPage,
};

_$ListReportsImpl _$$ListReportsImplFromJson(Map<String, dynamic> json) =>
    _$ListReportsImpl(
      unresolvedOnly: json['unresolved_only'] as bool?,
      myReportsOnly: json['my_reports_only'] as bool?,
      showCommunityRuleViolations:
          json['show_community_rule_violations'] as bool?,
...
Map<String, dynamic> _$$ListReportsImplToJson(_$ListReportsImpl instance) =>
    <String, dynamic>{
      ...
      if (instance.showCommunityRuleViolations case final value?)
        'show_community_rule_violations': value,
