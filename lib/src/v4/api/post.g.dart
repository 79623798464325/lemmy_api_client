...
_$WarnPostImpl _$$WarnPostImplFromJson(Map<String, dynamic> json) =>
    _$WarnPostImpl(
      postId: (json['post_id'] as num).toInt(),
      reason: json['reason'] as String,
    );

Map<String, dynamic> _$$WarnPostImplToJson(_$WarnPostImpl instance) =>
    <String, dynamic>{'post_id': instance.postId, 'reason': instance.reason};
...
Map<String, dynamic> _$$ModEditPostImplToJson(_$ModEditPostImpl instance) =>
    <String, dynamic>{
      'post_id': instance.postId,
      if (instance.nsfw case final value?) 'nsfw': value,
...
_$EditPostNotificationsImpl _$$EditPostNotificationsImplFromJson(
...
Map<String, dynamic> _$$EditPostNotificationsImplToJson(
  _$EditPostNotificationsImpl instance,
) => <String, dynamic>{'post_id': instance.postId, 'mode': instance.mode};
...
Map<String, dynamic> _$$HidePostImplToJson(_$HidePostImpl instance) =>
    <String, dynamic>{'post_id': instance.postId, 'hide': instance.hide};
...
) => <String, dynamic>{'post_id': instance.postId, 'read': instance.read};

_$MarkManyPostsAsReadImpl _$$MarkManyPostsAsReadImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$MarkManyPostsAsReadImplToJson(
  _$MarkManyPostsAsReadImpl instance,
) => <String, dynamic>{'post_ids': instance.postIds, 'read': instance.read};
