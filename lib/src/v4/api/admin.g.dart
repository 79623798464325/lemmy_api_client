...
Map<String, dynamic> _$$AddAdminImplToJson(_$AddAdminImpl instance) =>
    <String, dynamic>{'person_id': instance.personId, 'added': instance.added};
...
_$AdminAllowInstanceImpl _$$AdminAllowInstanceImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$AdminAllowInstanceImplToJson(
  _$AdminAllowInstanceImpl instance,
) => <String, dynamic>{
...
_$AdminBlockInstanceImpl _$$AdminBlockInstanceImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$AdminBlockInstanceImplToJson(
  _$AdminBlockInstanceImpl instance,
) => <String, dynamic>{
  'instance_id': instance.instanceId,
...
_$AdminListUsersImpl _$$AdminListUsersImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$AdminListUsersImplToJson(
  _$AdminListUsersImpl instance,
) => <String, dynamic>{
...
_$CreateTaglineImpl _$$CreateTaglineImplFromJson(Map<String, dynamic> json) =>
    _$CreateTaglineImpl(content: json['content'] as String);

Map<String, dynamic> _$$CreateTaglineImplToJson(_$CreateTaglineImpl instance) =>
    <String, dynamic>{'content': instance.content};

_$EditTaglineImpl _$$EditTaglineImplFromJson(Map<String, dynamic> json) =>
    _$EditTaglineImpl(
      id: (json['id'] as num).toInt(),
      content: json['content'] as String,
    );

Map<String, dynamic> _$$EditTaglineImplToJson(_$EditTaglineImpl instance) =>
    <String, dynamic>{'id': instance.id, 'content': instance.content};

_$DeleteTaglineImpl _$$DeleteTaglineImplFromJson(Map<String, dynamic> json) =>
    _$DeleteTaglineImpl(id: (json['id'] as num).toInt());

Map<String, dynamic> _$$DeleteTaglineImplToJson(_$DeleteTaglineImpl instance) =>
    <String, dynamic>{'id': instance.id};

_$ListTaglinesImpl _$$ListTaglinesImplFromJson(Map<String, dynamic> json) =>
    _$ListTaglinesImpl(
      limit: (json['limit'] as num?)?.toInt(),
      pageCursor: json['page_cursor'] as String?,
    );

Map<String, dynamic> _$$ListTaglinesImplToJson(_$ListTaglinesImpl instance) =>
    <String, dynamic>{
      if (instance.limit case final value?) 'limit': value,
      if (instance.pageCursor case final value?) 'page_cursor': value,
    };
...
) => <String, dynamic>{'person_id': instance.personId};
