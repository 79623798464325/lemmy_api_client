...
_$DeleteMediaImpl _$$DeleteMediaImplFromJson(Map<String, dynamic> json) =>
    _$DeleteMediaImpl(filename: json['filename'] as String);

Map<String, dynamic> _$$DeleteMediaImplToJson(_$DeleteMediaImpl instance) =>
...
_$UploadUserAvatarImpl _$$UploadUserAvatarImplFromJson(
  Map<String, dynamic> json,
) => _$UploadUserAvatarImpl();

Map<String, dynamic> _$$UploadUserAvatarImplToJson(
  _$UploadUserAvatarImpl instance,
) => <String, dynamic>{};

_$DeleteUserAvatarImpl _$$DeleteUserAvatarImplFromJson(
  Map<String, dynamic> json,
) => _$DeleteUserAvatarImpl();

Map<String, dynamic> _$$DeleteUserAvatarImplToJson(
  _$DeleteUserAvatarImpl instance,
) => <String, dynamic>{};

_$UploadUserBannerImpl _$$UploadUserBannerImplFromJson(
  Map<String, dynamic> json,
) => _$UploadUserBannerImpl();

Map<String, dynamic> _$$UploadUserBannerImplToJson(
  _$UploadUserBannerImpl instance,
) => <String, dynamic>{};

_$DeleteUserBannerImpl _$$DeleteUserBannerImplFromJson(
  Map<String, dynamic> json,
) => _$DeleteUserBannerImpl();

Map<String, dynamic> _$$DeleteUserBannerImplToJson(
  _$DeleteUserBannerImpl instance,
) => <String, dynamic>{};

_$ListLoginsImpl _$$ListLoginsImplFromJson(Map<String, dynamic> json) =>
    _$ListLoginsImpl();

Map<String, dynamic> _$$ListLoginsImplToJson(_$ListLoginsImpl instance) =>
    <String, dynamic>{};

_$CreateRegistrationInvitationImpl _$$CreateRegistrationInvitationImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$CreateRegistrationInvitationImplToJson(
  _$CreateRegistrationInvitationImpl instance,
) => <String, dynamic>{
...
_$ListRegistrationInvitationsImpl _$$ListRegistrationInvitationsImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ListRegistrationInvitationsImplToJson(
  _$ListRegistrationInvitationsImpl instance,
) => <String, dynamic>{
  if (instance.limit case final value?) 'limit': value,
  if (instance.pageCursor case final value?) 'page_cursor': value,
};

_$RevokeRegistrationInvitationImpl _$$RevokeRegistrationInvitationImplFromJson(
  Map<String, dynamic> json,
) => _$RevokeRegistrationInvitationImpl(token: json['token'] as String);

Map<String, dynamic> _$$RevokeRegistrationInvitationImplToJson(
  _$RevokeRegistrationInvitationImpl instance,
) => <String, dynamic>{'token': instance.token};

_$MarkDonationDialogShownImpl _$$MarkDonationDialogShownImplFromJson(
  Map<String, dynamic> json,
) => _$MarkDonationDialogShownImpl();

Map<String, dynamic> _$$MarkDonationDialogShownImplToJson(
  _$MarkDonationDialogShownImpl instance,
) => <String, dynamic>{};

_$UserBlockInstanceCommunitiesImpl _$$UserBlockInstanceCommunitiesImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$UserBlockInstanceCommunitiesImplToJson(
  _$UserBlockInstanceCommunitiesImpl instance,
) => <String, dynamic>{
  'instance_id': instance.instanceId,
  'block': instance.block,
};

_$UserBlockInstancePersonsImpl _$$UserBlockInstancePersonsImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$UserBlockInstancePersonsImplToJson(
  _$UserBlockInstancePersonsImpl instance,
) => <String, dynamic>{
  'instance_id': instance.instanceId,
  'block': instance.block,
};

_$ExportUserSettingsImpl _$$ExportUserSettingsImplFromJson(
  Map<String, dynamic> json,
) => _$ExportUserSettingsImpl();

Map<String, dynamic> _$$ExportUserSettingsImplToJson(
  _$ExportUserSettingsImpl instance,
) => <String, dynamic>{};

_$ImportUserSettingsImpl _$$ImportUserSettingsImplFromJson(
  Map<String, dynamic> json,
  ...
  settings:
      json['settings'] == null
          ? null
          : LocalUser.fromJson(json['settings'] as Map<String, dynamic>),
  followedCommunities:
      (json['followed_communities'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList(),
  savedPosts:
      (json['saved_posts'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList(),
  savedComments:
      (json['saved_comments'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList(),
  blockedCommunities:
      (json['blocked_communities'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList(),
  blockedUsers:
  ...
  blockedInstancesCommunities:
      (json['blocked_instances_communities'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList(),
  blockedInstancesPersons:
      (json['blocked_instances_persons'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList(),
  blockingKeywords:
      (json['blocking_keywords'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
  discussionLanguages:
      (json['discussion_languages'] as List<dynamic>?)
...
Map<String, dynamic> _$$ImportUserSettingsImplToJson(
  _$ImportUserSettingsImpl instance,
) => <String, dynamic>{
  ...
  if (instance.followedCommunities case final value?)
    'followed_communities': value,
  if (instance.savedPosts case final value?) 'saved_posts': value,
  if (instance.savedComments case final value?) 'saved_comments': value,
  if (instance.blockedCommunities case final value?)
    'blocked_communities': value,
  if (instance.blockedUsers case final value?) 'blocked_users': value,
  if (instance.blockedInstancesCommunities case final value?)
    'blocked_instances_communities': value,
  if (instance.blockedInstancesPersons case final value?)
    'blocked_instances_persons': value,
...
_$EditTotpImpl _$$EditTotpImplFromJson(Map<String, dynamic> json) =>
    _$EditTotpImpl(
      totpToken: json['totp_token'] as String,
      enabled: json['enabled'] as bool,
    );

Map<String, dynamic> _$$EditTotpImplToJson(_$EditTotpImpl instance) =>
    <String, dynamic>{
