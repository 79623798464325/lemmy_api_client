...
Map<String, dynamic> _$$PersonBlockViewImplToJson(_$PersonBlockViewImpl instance) => <String, dynamic>{'person': instance.person.toJson(), 'target': instance.target.toJson()};

_$InstanceBlockViewImpl _$$InstanceBlockViewImplFromJson(Map<String, dynamic> json) =>
    _$InstanceBlockViewImpl(person: Person.fromJson(json['person'] as Map<String, dynamic>), instance: Instance.fromJson(json['instance'] as Map<String, dynamic>));

Map<String, dynamic> _$$InstanceBlockViewImplToJson(_$InstanceBlockViewImpl instance) => <String, dynamic>{'person': instance.person.toJson(), 'instance': instance.instance.toJson()};
