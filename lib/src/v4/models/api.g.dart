...
_$GetCommentsSlimResponseImpl _$$GetCommentsSlimResponseImplFromJson(
  Map<String, dynamic> json,
) => _$GetCommentsSlimResponseImpl(
  comments:
      (json['items'] as List<dynamic>?)
          ?.map((e) => CommentSlimView.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
  nextPage: json['next_page'] as String?,
);

Map<String, dynamic> _$$GetCommentsSlimResponseImplToJson(
  _$GetCommentsSlimResponseImpl instance,
) => <String, dynamic>{
  'items': instance.comments.map((e) => e.toJson()).toList(),
  'next_page': instance.nextPage,
};
...
_$PostReportViewImpl _$$PostReportViewImplFromJson(
  ...
  creatorBanExpiresAt: _$JsonConverterFromJson<String, DateTime>(
    json['creator_ban_expires_at'],
    const ForceUtcDateTime().fromJson,
  ),
  creatorCommunityBanExpiresAt: _$JsonConverterFromJson<String, DateTime>(
    json['creator_community_ban_expires_at'],
    const ForceUtcDateTime().fromJson,
  ),
  ...
  tags:
      ...
      const [],
  postActions:
      json['post_actions'] == null
          ? null
          : PostActions.fromJson(json['post_actions'] as Map<String, dynamic>),
  personActions:
      json['person_actions'] == null
          ? null
          : PersonActions.fromJson(
            json['person_actions'] as Map<String, dynamic>,
          ),
  communityActions:
      json['community_actions'] == null
          ? null
          : CommunityActions.fromJson(
            json['community_actions'] as Map<String, dynamic>,
          ),
  resolver:
      json['resolver'] == null
          ? null
...
Map<String, dynamic> _$$PostReportViewImplToJson(
  ...
  'creator_ban_expires_at': _$JsonConverterToJson<String, DateTime>(
    instance.creatorBanExpiresAt,
    const ForceUtcDateTime().toJson,
  ),
  'creator_community_ban_expires_at': _$JsonConverterToJson<String, DateTime>(
    instance.creatorCommunityBanExpiresAt,
    const ForceUtcDateTime().toJson,
  ),
...
_$CommentReportViewImpl _$$CommentReportViewImplFromJson(
  ...
  commentActions:
      json['comment_actions'] == null
          ? null
          : CommentActions.fromJson(
            json['comment_actions'] as Map<String, dynamic>,
          ),
  communityActions:
      json['community_actions'] == null
          ? null
...
_$ListPersonsResponseImpl _$$ListPersonsResponseImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ListPersonsResponseImplToJson(
  _$ListPersonsResponseImpl instance,
) => <String, dynamic>{
...
_$ListPersonContentResponseImpl _$$ListPersonContentResponseImplFromJson(
  Map<String, dynamic> json,
) => _$ListPersonContentResponseImpl(
  items:
      (json['items'] as List<dynamic>?)
          ?.map(
            (e) => PostCommentCombinedView.fromJson(e as Map<String, dynamic>),
          )
          .toList() ??
      const [],
  nextPage: json['next_page'] as String?,
...
Map<String, dynamic> _$$ListPersonContentResponseImplToJson(
  _$ListPersonContentResponseImpl instance,
) => <String, dynamic>{
...
_$CommunityReportResponseImpl _$$CommunityReportResponseImplFromJson(
  ...
  communityReportView: CommunityReportView.fromJson(
    json['community_report_view'] as Map<String, dynamic>,
  ),
);
...
Map<String, dynamic> _$$CommunityReportResponseImplToJson(
  ...
  'community_report_view': instance.communityReportView.toJson(),
};

_$ListPendingFollowsResponseImpl _$$ListPendingFollowsResponseImplFromJson(
  Map<String, dynamic> json,
) => _$ListPendingFollowsResponseImpl(
  items:
      (json['items'] as List<dynamic>?)
          ?.map((e) => PendingFollowerView.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
  prevPage: json['prev_page'] as String?,
  nextPage: json['next_page'] as String?,
...
Map<String, dynamic> _$$ListPendingFollowsResponseImplToJson(
  _$ListPendingFollowsResponseImpl instance,
) => <String, dynamic>{
  'items': instance.items.map((e) => e.toJson()).toList(),
  'prev_page': instance.prevPage,
  'next_page': instance.nextPage,
...
Map<String, dynamic> _$$SiteResponseImplToJson(_$SiteResponseImpl instance) =>
    <String, dynamic>{'site_view': instance.siteView.toJson()};

_$TaglineResponseImpl _$$TaglineResponseImplFromJson(
  Map<String, dynamic> json,
) => _$TaglineResponseImpl(
  tagline: Tagline.fromJson(json['tagline'] as Map<String, dynamic>),
);

Map<String, dynamic> _$$TaglineResponseImplToJson(
  _$TaglineResponseImpl instance,
) => <String, dynamic>{'tagline': instance.tagline.toJson()};
...
_$ListVotesResponseImpl _$$ListVotesResponseImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ListVotesResponseImplToJson(
  _$ListVotesResponseImpl instance,
) => <String, dynamic>{
  'items': instance.items.map((e) => e.toJson()).toList(),
  'prev_page': instance.prevPage,
  'next_page': instance.nextPage,
...
_$ListLocalUsersResponseImpl _$$ListLocalUsersResponseImplFromJson(
  Map<String, dynamic> json,
) => _$ListLocalUsersResponseImpl(
  items:
      (json['items'] as List<dynamic>?)
          ?.map((e) => LocalUserView.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
  prevPage: json['prev_page'] as String?,
  nextPage: json['next_page'] as String?,
...
Map<String, dynamic> _$$ListLocalUsersResponseImplToJson(
  _$ListLocalUsersResponseImpl instance,
) => <String, dynamic>{
  'items': instance.items.map((e) => e.toJson()).toList(),
  'prev_page': instance.prevPage,
  'next_page': instance.nextPage,
...
_$ListTaglinesResponseImpl _$$ListTaglinesResponseImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ListTaglinesResponseImplToJson(
  _$ListTaglinesResponseImpl instance,
) => <String, dynamic>{
  'items': instance.items.map((e) => e.toJson()).toList(),
  'prev_page': instance.prevPage,
  'next_page': instance.nextPage,
...
_$MultiCommunityResponseImpl _$$MultiCommunityResponseImplFromJson(
  Map<String, dynamic> json,
) => _$MultiCommunityResponseImpl(
  multiCommunityView: MultiCommunityView.fromJson(
    json['multi_community_view'] as Map<String, dynamic>,
  ),
);

Map<String, dynamic> _$$MultiCommunityResponseImplToJson(
  _$MultiCommunityResponseImpl instance,
) => <String, dynamic>{
  'multi_community_view': instance.multiCommunityView.toJson(),
};

_$GetMultiCommunityResponseImpl _$$GetMultiCommunityResponseImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$GetMultiCommunityResponseImplToJson(
  _$GetMultiCommunityResponseImpl instance,
) => <String, dynamic>{
  'multi_community_view': instance.multiCommunityView.toJson(),
  'communities': instance.communities.map((e) => e.toJson()).toList(),
};
...
) => <String, dynamic>{'custom_emoji': instance.customEmoji.toJson()};

_$ListCustomEmojisResponseImpl _$$ListCustomEmojisResponseImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ListCustomEmojisResponseImplToJson(
  _$ListCustomEmojisResponseImpl instance,
) => <String, dynamic>{
  'custom_emojis': instance.customEmojis.map((e) => e.toJson()).toList(),
};

_$ListLoginsResponseImpl _$$ListLoginsResponseImplFromJson(
  Map<String, dynamic> json,
) => _$ListLoginsResponseImpl(
  logins:
      (json['logins'] as List<dynamic>?)
          ?.map((e) => LoginToken.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
);

Map<String, dynamic> _$$ListLoginsResponseImplToJson(
  _$ListLoginsResponseImpl instance,
) => <String, dynamic>{
  'logins': instance.logins.map((e) => e.toJson()).toList(),
};

_$CreateInvitationResponseImpl _$$CreateInvitationResponseImplFromJson(
  Map<String, dynamic> json,
) => _$CreateInvitationResponseImpl(
  invite: LocalUserInvite.fromJson(json['invite'] as Map<String, dynamic>),
);

Map<String, dynamic> _$$CreateInvitationResponseImplToJson(
  _$CreateInvitationResponseImpl instance,
) => <String, dynamic>{'invite': instance.invite.toJson()};

_$ListInvitationsResponseImpl _$$ListInvitationsResponseImplFromJson(
  Map<String, dynamic> json,
) => _$ListInvitationsResponseImpl(
  items:
      (json['items'] as List<dynamic>?)
          ?.map((e) => LocalUserInvite.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
  prevPage: json['prev_page'] as String?,
  nextPage: json['next_page'] as String?,
...
Map<String, dynamic> _$$ListInvitationsResponseImplToJson(
  _$ListInvitationsResponseImpl instance,
) => <String, dynamic>{
  'items': instance.items.map((e) => e.toJson()).toList(),
  'prev_page': instance.prevPage,
  'next_page': instance.nextPage,
...
) => <String, dynamic>{'totp_secret_url': instance.totpSecretUrl};

_$EditTotpResponseImpl _$$EditTotpResponseImplFromJson(
  Map<String, dynamic> json,
) => _$EditTotpResponseImpl(enabled: json['enabled'] as bool);

Map<String, dynamic> _$$EditTotpResponseImplToJson(
  _$EditTotpResponseImpl instance,
) => <String, dynamic>{'enabled': instance.enabled};

_$ListMultiCommunitiesResponseImpl _$$ListMultiCommunitiesResponseImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$ListMultiCommunitiesResponseImplToJson(
  _$ListMultiCommunitiesResponseImpl instance,
) => <String, dynamic>{
  'items': instance.items.map((e) => e.toJson()).toList(),
  'prev_page': instance.prevPage,
  'next_page': instance.nextPage,
...
_$$ApproveRegistrationApplicationResponseImplFromJson(
  Map<String, dynamic> json,
) => _$ApproveRegistrationApplicationResponseImpl(
  registrationApplication: RegistrationApplicationView.fromJson(
    json['registration_application'] as Map<String, dynamic>,
...
Map<String, dynamic> _$$ApproveRegistrationApplicationResponseImplToJson(
  _$ApproveRegistrationApplicationResponseImpl instance,
) => <String, dynamic>{
  'registration_application': instance.registrationApplication.toJson(),
};
...
_$$ListRegistrationApplicationsResponseImplFromJson(
  ...
  registrationApplications:
      (json['registration_applications'] as List<dynamic>?)
          ?.map(
            (e) =>
                RegistrationApplicationView.fromJson(e as Map<String, dynamic>),
          )
          .toList() ??
      const [],
  nextPage: json['next_page'] as String?,
