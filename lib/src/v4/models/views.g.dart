...
_$PersonActionsImpl _$$PersonActionsImplFromJson(Map<String, dynamic> json) =>
    _$PersonActionsImpl(
      blockedAt: _$JsonConverterFromJson<String, DateTime>(
        json['blocked_at'],
        const ForceUtcDateTime().fromJson,
      ),
      notedAt: _$JsonConverterFromJson<String, DateTime>(
        json['noted_at'],
        const ForceUtcDateTime().fromJson,
      ),
      note: json['note'] as String?,
      votedAt: _$JsonConverterFromJson<String, DateTime>(
        json['voted_at'],
        const ForceUtcDateTime().fromJson,
      ),
...
Map<String, dynamic> _$$PersonActionsImplToJson(_$PersonActionsImpl instance) =>
    <String, dynamic>{
      'blocked_at': _$JsonConverterToJson<String, DateTime>(
        instance.blockedAt,
        const ForceUtcDateTime().toJson,
      ),
      'noted_at': _$JsonConverterToJson<String, DateTime>(
        instance.notedAt,
        const ForceUtcDateTime().toJson,
      ),
      'note': instance.note,
      'voted_at': _$JsonConverterToJson<String, DateTime>(
        instance.votedAt,
        const ForceUtcDateTime().toJson,
      ),
...
_$CommunityActionsImpl _$$CommunityActionsImplFromJson(
  ...
  followedAt: _$JsonConverterFromJson<String, DateTime>(
    json['followed_at'],
    const ForceUtcDateTime().fromJson,
  ),
  blockedAt: _$JsonConverterFromJson<String, DateTime>(
  ...
  becameModeratorAt: _$JsonConverterFromJson<String, DateTime>(
    json['became_moderator_at'],
    const ForceUtcDateTime().fromJson,
  ),
  receivedBanAt: _$JsonConverterFromJson<String, DateTime>(
    json['received_ban_at'],
    const ForceUtcDateTime().fromJson,
  ),
  banExpiresAt: _$JsonConverterFromJson<String, DateTime>(
    json['ban_expires_at'],
  ...
  notifications:
      json['notifications'] == null
          ? null
          : CommunityNotificationsMode.fromJson(json['notifications']),
);

Map<String, dynamic> _$$CommunityActionsImplToJson(
  _$CommunityActionsImpl instance,
) => <String, dynamic>{
  'followed_at': _$JsonConverterToJson<String, DateTime>(
    instance.followedAt,
    const ForceUtcDateTime().toJson,
  ),
  'blocked_at': _$JsonConverterToJson<String, DateTime>(
  ...
  'became_moderator_at': _$JsonConverterToJson<String, DateTime>(
    instance.becameModeratorAt,
    const ForceUtcDateTime().toJson,
  ),
  'received_ban_at': _$JsonConverterToJson<String, DateTime>(
    instance.receivedBanAt,
    const ForceUtcDateTime().toJson,
  ),
  'ban_expires_at': _$JsonConverterToJson<String, DateTime>(
    instance.banExpiresAt,
...
_$PostViewImpl _$$PostViewImplFromJson(
  Map<String, dynamic> json,
) => _$PostViewImpl(
...
Map<String, dynamic> _$$PostViewImplToJson(
  _$PostViewImpl instance,
) => <String, dynamic>{
...
_$PostActionsImpl _$$PostActionsImplFromJson(Map<String, dynamic> json) =>
    _$PostActionsImpl(
      ...
      hiddenAt: _$JsonConverterFromJson<String, DateTime>(
        json['hidden_at'],
        const ForceUtcDateTime().fromJson,
      ),
      readCommentsAt: _$JsonConverterFromJson<String, DateTime>(
        json['read_comments_at'],
        const ForceUtcDateTime().fromJson,
      ),
      ...
      notifications:
          json['notifications'] == null
              ? null
              : PostNotificationsMode.fromJson(json['notifications']),
    );

Map<String, dynamic> _$$PostActionsImplToJson(_$PostActionsImpl instance) =>
    <String, dynamic>{
      'saved_at': _$JsonConverterToJson<String, DateTime>(
        instance.savedAt,
        const ForceUtcDateTime().toJson,
      ),
      ...
      'hidden_at': _$JsonConverterToJson<String, DateTime>(
        instance.hiddenAt,
        const ForceUtcDateTime().toJson,
      ),
      'read_comments_at': _$JsonConverterToJson<String, DateTime>(
        instance.readCommentsAt,
        const ForceUtcDateTime().toJson,
      ),
...
Map<String, dynamic> _$$CommentViewImplToJson(
  _$CommentViewImpl instance,
) => <String, dynamic>{
...
_$CommentActionsImpl _$$CommentActionsImplFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$CommentActionsImplToJson(
  _$CommentActionsImpl instance,
) => <String, dynamic>{
  'saved_at': _$JsonConverterToJson<String, DateTime>(
    instance.savedAt,
    const ForceUtcDateTime().toJson,
...
_$PendingFollowerViewImpl _$$PendingFollowerViewImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$PendingFollowerViewImplToJson(
  _$PendingFollowerViewImpl instance,
) => <String, dynamic>{
  'person': instance.person.toJson(),
  'community': instance.community.toJson(),
  'follow_state': instance.followState.toJson(),
...
_$CommunityReportViewImpl _$$CommunityReportViewImplFromJson(
  Map<String, dynamic> json,
) => _$CommunityReportViewImpl(
  communityReport: CommunityReport.fromJson(
    json['community_report'] as Map<String, dynamic>,
  ),
  community: Community.fromJson(json['community'] as Map<String, dynamic>),
  creator: Person.fromJson(json['creator'] as Map<String, dynamic>),
  resolver:
...
Map<String, dynamic> _$$CommunityReportViewImplToJson(
  _$CommunityReportViewImpl instance,
) => <String, dynamic>{
...
_$LocalImageViewImpl _$$LocalImageViewImplFromJson(Map<String, dynamic> json) =>
    _$LocalImageViewImpl(
      localImage: LocalImage.fromJson(
        json['local_image'] as Map<String, dynamic>,
      ),
      person: Person.fromJson(json['person'] as Map<String, dynamic>),
      post:
          json['post'] == null
...
_$MultiCommunityViewImpl _$$MultiCommunityViewImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$MultiCommunityViewImplToJson(
  _$MultiCommunityViewImpl instance,
) => <String, dynamic>{
...
_$CustomEmojiViewImpl _$$CustomEmojiViewImplFromJson(
  ...
  customEmoji: CustomEmoji.fromJson(
...
_$NodeInfoImpl _$$NodeInfoImplFromJson(
  Map<String, dynamic> json,
) => _$NodeInfoImpl(
...
_$NodeInfoSoftwareImpl _$$NodeInfoSoftwareImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$NodeInfoSoftwareImplToJson(
  _$NodeInfoSoftwareImpl instance,
) => <String, dynamic>{
  'name': instance.name,
  'version': instance.version,
...
_$NodeInfoUsageImpl _$$NodeInfoUsageImplFromJson(Map<String, dynamic> json) =>
    _$NodeInfoUsageImpl(
      users: NodeInfoUsers.fromJson(json['users'] as Map<String, dynamic>),
      localPosts: (json['local_posts'] as num).toInt(),
      localComments: (json['local_comments'] as num).toInt(),
    );

Map<String, dynamic> _$$NodeInfoUsageImplToJson(_$NodeInfoUsageImpl instance) =>
    <String, dynamic>{
...
_$NodeInfoUsersImpl _$$NodeInfoUsersImplFromJson(Map<String, dynamic> json) =>
    _$NodeInfoUsersImpl(
      ...
      activeHalfyear: (json['active_halfyear'] as num).toInt(),
      activeMonth: (json['active_month'] as num).toInt(),
    );

Map<String, dynamic> _$$NodeInfoUsersImplToJson(_$NodeInfoUsersImpl instance) =>
    <String, dynamic>{
...
_$NodeInfoServicesImpl _$$NodeInfoServicesImplFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$$NodeInfoServicesImplToJson(
  _$NodeInfoServicesImpl instance,
) => <String, dynamic>{
