...
_$SiteImpl _$$SiteImplFromJson(Map<String, dynamic> json) => _$SiteImpl(
  ...
  publishedAt: const ForceUtcDateTime().fromJson(json['published_at'] as String),
  updatedAt: _$JsonConverterFromJson<String, DateTime>(json['updated_at'], const ForceUtcDateTime().fromJson),
...
Map<String, dynamic> _$$SiteImplToJson(_$SiteImpl instance) => <String, dynamic>{
  ...
  'updated_at': _$JsonConverterToJson<String, DateTime>(instance.updatedAt, const ForceUtcDateTime().toJson),
  'icon': instance.icon,
...
_$LocalSiteImpl _$$LocalSiteImplFromJson(Map<String, dynamic> json) => _$LocalSiteImpl(
  ...
  defaultCommentSortType: json['default_comment_sort_type'] == null ? null : CommentSortType.fromJson(json['default_comment_sort_type']),
...
_$LocalSiteRateLimitImpl _$$LocalSiteRateLimitImplFromJson(Map<String, dynamic> json) => _$LocalSiteRateLimitImpl(
  ...
  publishedAt: const ForceUtcDateTime().fromJson(json['published_at'] as String),
  updatedAt: _$JsonConverterFromJson<String, DateTime>(json['updated_at'], const ForceUtcDateTime().fromJson),
  importUserSettingsMaxRequests: (json['import_user_settings_max_requests'] as num?)?.toInt(),
  importUserSettingsIntervalSeconds: (json['import_user_settings_interval_seconds'] as num?)?.toInt(),
);
...
Map<String, dynamic> _$$LocalSiteRateLimitImplToJson(_$LocalSiteRateLimitImpl instance) => <String, dynamic>{
  ...
  'import_user_settings_interval_seconds': instance.importUserSettingsIntervalSeconds,
};
...
Map<String, dynamic> _$$PostImplToJson(_$PostImpl instance) => <String, dynamic>{
  ...
  'scheduled_publish_time': _$JsonConverterToJson<String, DateTime>(instance.scheduledPublishTime, const ForceUtcDateTime().toJson),
  'comments': instance.comments,
...
_$LanguageImpl _$$LanguageImplFromJson(Map<String, dynamic> json) => _$LanguageImpl(id: (json['id'] as num).toInt(), code: json['code'] as String, name: json['name'] as String);

Map<String, dynamic> _$$LanguageImplToJson(_$LanguageImpl instance) => <String, dynamic>{'id': instance.id, 'code': instance.code, 'name': instance.name};
...
_$CommunityTagImpl _$$CommunityTagImplFromJson(Map<String, dynamic> json) => _$CommunityTagImpl(
  id: (json['id'] as num).toInt(),
  apId: json['ap_id'] as String,
  name: json['name'] as String,
  displayName: json['display_name'] as String?,
...
Map<String, dynamic> _$$CommunityTagImplToJson(_$CommunityTagImpl instance) => <String, dynamic>{
  'id': instance.id,
  'ap_id': instance.apId,
  'name': instance.name,
  'display_name': instance.displayName,
...
_$CommunityReportImpl _$$CommunityReportImplFromJson(Map<String, dynamic> json) => _$CommunityReportImpl(
  id: (json['id'] as num).toInt(),
  creatorId: (json['creator_id'] as num).toInt(),
  communityId: (json['community_id'] as num).toInt(),
...
Map<String, dynamic> _$$CommunityReportImplToJson(_$CommunityReportImpl instance) => <String, dynamic>{
  'id': instance.id,
  'creator_id': instance.creatorId,
  'community_id': instance.communityId,
...
_$MultiCommunityImpl _$$MultiCommunityImplFromJson(Map<String, dynamic> json) => _$MultiCommunityImpl(
  id: (json['id'] as num).toInt(),
  creatorId: (json['creator_id'] as num).toInt(),
  instanceId: (json['instance_id'] as num).toInt(),
  name: json['name'] as String,
  ...
  subscribers: (json['subscribers'] as num).toInt(),
  subscribersLocal: (json['subscribers_local'] as num).toInt(),
  communities: (json['communities'] as List<dynamic>).map((e) => (e as num).toInt()).toList(),
  sidebar: json['sidebar'] as String?,
);

Map<String, dynamic> _$$MultiCommunityImplToJson(_$MultiCommunityImpl instance) => <String, dynamic>{
  'id': instance.id,
  'creator_id': instance.creatorId,
  'instance_id': instance.instanceId,
  'name': instance.name,
...
_$CustomEmojiKeywordImpl _$$CustomEmojiKeywordImplFromJson(Map<String, dynamic> json) =>
    _$CustomEmojiKeywordImpl(customEmojiId: (json['custom_emoji_id'] as num).toInt(), keyword: json['keyword'] as String);

Map<String, dynamic> _$$CustomEmojiKeywordImplToJson(_$CustomEmojiKeywordImpl instance) => <String, dynamic>{'custom_emoji_id': instance.customEmojiId, 'keyword': instance.keyword};

_$AdminOAuthProviderImpl _$$AdminOAuthProviderImplFromJson(Map<String, dynamic> json) => _$AdminOAuthProviderImpl(
  id: (json['id'] as num).toInt(),
  displayName: json['display_name'] as String,
...
Map<String, dynamic> _$$AdminOAuthProviderImplToJson(_$AdminOAuthProviderImpl instance) => <String, dynamic>{
  'id': instance.id,
  'display_name': instance.displayName,
...
_$PublicOAuthProviderImpl _$$PublicOAuthProviderImplFromJson(Map<String, dynamic> json) => _$PublicOAuthProviderImpl(
  id: (json['id'] as num).toInt(),
  displayName: json['display_name'] as String,
  authorizationEndpoint: json['authorization_endpoint'] as String,
  clientId: json['client_id'] as String,
...
Map<String, dynamic> _$$PublicOAuthProviderImplToJson(_$PublicOAuthProviderImpl instance) => <String, dynamic>{
  'id': instance.id,
  'display_name': instance.displayName,
  'authorization_endpoint': instance.authorizationEndpoint,
  'client_id': instance.clientId,
...
_$LoginTokenImpl _$$LoginTokenImplFromJson(Map<String, dynamic> json) => _$LoginTokenImpl(
...
Map<String, dynamic> _$$LoginTokenImplToJson(_$LoginTokenImpl instance) => <String, dynamic>{
...
_$LocalUserInviteImpl _$$LocalUserInviteImplFromJson(Map<String, dynamic> json) => _$LocalUserInviteImpl(
  id: (json['id'] as num).toInt(),
...
Map<String, dynamic> _$$LocalUserInviteImplToJson(_$LocalUserInviteImpl instance) => <String, dynamic>{
  'id': instance.id,
  'token': instance.token,
  'local_user_id': instance.localUserId,
  'max_uses': instance.maxUses,
  'uses_count': instance.usesCount,
  'expires_at': _$JsonConverterToJson<String, DateTime>(instance.expiresAt, const ForceUtcDateTime().toJson),
  'published_at': const ForceUtcDateTime().toJson(instance.publishedAt),
};
