...
class PostAggregates with _$PostAggregates {
  @modelSerde
  const factory PostAggregates({required int postId, required int comments, required int score, required int upvotes, required int downvotes}) = _PostAggregates;
...
class CommentAggregates with _$CommentAggregates {
  @modelSerde
  const factory CommentAggregates({required int commentId, required int score, required int upvotes, required int downvotes, int? childCount, int? hotRank}) = _CommentAggregates;
