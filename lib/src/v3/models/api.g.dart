...
_$FullCommunityViewImpl _$$FullCommunityViewImplFromJson(Map<String, dynamic> json) => _$FullCommunityViewImpl(
...
Map<String, dynamic> _$$FullCommunityViewImplToJson(_$FullCommunityViewImpl instance) => <String, dynamic>{
...
_$FullPostViewImpl _$$FullPostViewImplFromJson(Map<String, dynamic> json) => _$FullPostViewImpl(
...
Map<String, dynamic> _$$FullPostViewImplToJson(_$FullPostViewImpl instance) => <String, dynamic>{
...
_$SearchResultsImpl _$$SearchResultsImplFromJson(Map<String, dynamic> json) => _$SearchResultsImpl(
  ...
  users: (json['users'] as List<dynamic>).map((e) => PersonViewSafe.fromJson(e as Map<String, dynamic>)).toList(),
  instanceHost: json['instance_host'] as String,
);

Map<String, dynamic> _$$SearchResultsImplToJson(_$SearchResultsImpl instance) => <String, dynamic>{
...
Map<String, dynamic> _$$ModlogImplToJson(_$ModlogImpl instance) => <String, dynamic>{
...
_$FullCommentViewImpl _$$FullCommentViewImplFromJson(Map<String, dynamic> json) => _$FullCommentViewImpl(
...
Map<String, dynamic> _$$FullCommentViewImplToJson(_$FullCommentViewImpl instance) => <String, dynamic>{
...
_$FullSiteViewImpl _$$FullSiteViewImplFromJson(Map<String, dynamic> json) => _$FullSiteViewImpl(
  siteView: json['site_view'] == null ? null : SiteView.fromJson(json['site_view'] as Map<String, dynamic>),
  admins: (json['admins'] as List<dynamic>).map((e) => PersonViewSafe.fromJson(e as Map<String, dynamic>)).toList(),
  version: json['version'] as String,
  myUser: json['my_user'] == null ? null : MyUserInfo.fromJson(json['my_user'] as Map<String, dynamic>),
  federatedInstances: json['federated_instances'] == null ? null : FederatedInstances.fromJson(json['federated_instances'] as Map<String, dynamic>),
  instanceHost: json['instance_host'] as String,
);

Map<String, dynamic> _$$FullSiteViewImplToJson(_$FullSiteViewImpl instance) => <String, dynamic>{
...
_$MyUserInfoImpl _$$MyUserInfoImplFromJson(Map<String, dynamic> json) => _$MyUserInfoImpl(
  localUserView: LocalUserSettingsView.fromJson(json['local_user_view'] as Map<String, dynamic>),
...
_$FederatedInstancesImpl _$$FederatedInstancesImplFromJson(Map<String, dynamic> json) => _$FederatedInstancesImpl(
  ...
  allowed: (json['allowed'] as List<dynamic>?)?.map((e) => e as String).toList(),
  blocked: (json['blocked'] as List<dynamic>?)?.map((e) => e as String).toList(),
  instanceHost: json['instance_host'] as String,
);
...
_$CaptchaImpl _$$CaptchaImplFromJson(Map<String, dynamic> json) => _$CaptchaImpl(png: json['png'] as String, wav: json['wav'] as String?, uuid: json['uuid'] as String);

Map<String, dynamic> _$$CaptchaImplToJson(_$CaptchaImpl instance) => <String, dynamic>{'png': instance.png, 'wav': instance.wav, 'uuid': instance.uuid};

_$FullPersonViewImpl _$$FullPersonViewImplFromJson(Map<String, dynamic> json) => _$FullPersonViewImpl(
  personView: PersonViewSafe.fromJson(json['person_view'] as Map<String, dynamic>),
  moderates: (json['moderates'] as List<dynamic>).map((e) => CommunityModeratorView.fromJson(e as Map<String, dynamic>)).toList(),
  comments: (json['comments'] as List<dynamic>).map((e) => CommentView.fromJson(e as Map<String, dynamic>)).toList(),
  posts: (json['posts'] as List<dynamic>).map((e) => PostView.fromJson(e as Map<String, dynamic>)).toList(),
  instanceHost: json['instance_host'] as String,
...
Map<String, dynamic> _$$FullPersonViewImplToJson(_$FullPersonViewImpl instance) => <String, dynamic>{
...
_$BannedCommunityUserImpl _$$BannedCommunityUserImplFromJson(Map<String, dynamic> json) =>
    _$BannedCommunityUserImpl(personView: PersonViewSafe.fromJson(json['person_view'] as Map<String, dynamic>), banned: json['banned'] as bool, instanceHost: json['instance_host'] as String);

Map<String, dynamic> _$$BannedCommunityUserImplToJson(_$BannedCommunityUserImpl instance) => <String, dynamic>{
  'person_view': instance.personView.toJson(),
...
_$BannedPersonImpl _$$BannedPersonImplFromJson(Map<String, dynamic> json) =>
    _$BannedPersonImpl(personView: PersonViewSafe.fromJson(json['person_view'] as Map<String, dynamic>), banned: json['banned'] as bool, instanceHost: json['instance_host'] as String);

Map<String, dynamic> _$$BannedPersonImplToJson(_$BannedPersonImpl instance) => <String, dynamic>{
  'person_view': instance.personView.toJson(),
  'banned': instance.banned,
  'instance_host': instance.instanceHost,
};
...
_$ResolveObjectResponseImpl _$$ResolveObjectResponseImplFromJson(Map<String, dynamic> json) => _$ResolveObjectResponseImpl(
  ...
  person: json['person'] == null ? null : PersonViewSafe.fromJson(json['person'] as Map<String, dynamic>),
  instanceHost: json['instance_host'] as String,
);
...
_$BlockedPersonImpl _$$BlockedPersonImplFromJson(Map<String, dynamic> json) =>
    _$BlockedPersonImpl(personView: PersonViewSafe.fromJson(json['person_view'] as Map<String, dynamic>), blocked: json['blocked'] as bool, instanceHost: json['instance_host'] as String);

Map<String, dynamic> _$$BlockedPersonImplToJson(_$BlockedPersonImpl instance) => <String, dynamic>{
  'person_view': instance.personView.toJson(),
  'blocked': instance.blocked,
  'instance_host': instance.instanceHost,
};

_$BlockedCommunityImpl _$$BlockedCommunityImplFromJson(Map<String, dynamic> json) =>
    _$BlockedCommunityImpl(communityView: CommunityView.fromJson(json['community_view'] as Map<String, dynamic>), blocked: json['blocked'] as bool, instanceHost: json['instance_host'] as String);

Map<String, dynamic> _$$BlockedCommunityImplToJson(_$BlockedCommunityImpl instance) => <String, dynamic>{
  'community_view': instance.communityView.toJson(),
  'blocked': instance.blocked,
  'instance_host': instance.instanceHost,
};

_$ReportCountImpl _$$ReportCountImplFromJson(Map<String, dynamic> json) => _$ReportCountImpl(
...
Map<String, dynamic> _$$ReportCountImplToJson(_$ReportCountImpl instance) => <String, dynamic>{
...
_$UnreadCountImpl _$$UnreadCountImplFromJson(Map<String, dynamic> json) => _$UnreadCountImpl(
...
Map<String, dynamic> _$$UnreadCountImplToJson(_$UnreadCountImpl instance) => <String, dynamic>{
