...
_$FeaturePostImpl _$$FeaturePostImplFromJson(Map<String, dynamic> json) =>
    _$FeaturePostImpl(postId: (json['post_id'] as num).toInt(), featured: json['featured'] as bool, featureType: PostFeatureType.fromJson(json['feature_type']), auth: json['auth'] as String);
