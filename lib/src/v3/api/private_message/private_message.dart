...
import '../../models/private_message/list_private_message_reports_response.dart';
...
@freezed
class CreatePrivateMessage with _$CreatePrivateMessage implements LemmyApiQuery<PrivateMessageView> {
  @apiSerde
  const factory CreatePrivateMessage({required String content, required int recipientId, required String auth}) = _CreatePrivateMessage;
  ...
  @override
  PrivateMessageView responseFactory(Map<String, dynamic> json) => PrivateMessageView.fromJson(json['private_message_view']);
}
