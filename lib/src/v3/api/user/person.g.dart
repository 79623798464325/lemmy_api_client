...
Map<String, dynamic> _$$AddAdminImplToJson(_$AddAdminImpl instance) => <String, dynamic>{'person_id': instance.personId, 'added': instance.added, 'auth': instance.auth};
...
_$DeleteAccountImpl _$$DeleteAccountImplFromJson(Map<String, dynamic> json) => _$DeleteAccountImpl(password: json['password'] as String, auth: json['auth'] as String);

Map<String, dynamic> _$$DeleteAccountImplToJson(_$DeleteAccountImpl instance) => <String, dynamic>{'password': instance.password, 'auth': instance.auth};
...
_$PasswordChangeImpl _$$PasswordChangeImplFromJson(Map<String, dynamic> json) =>
    _$PasswordChangeImpl(token: json['token'] as String, password: json['password'] as String, passwordVerify: json['password_verify'] as String);

Map<String, dynamic> _$$PasswordChangeImplToJson(_$PasswordChangeImpl instance) => <String, dynamic>{
...
Map<String, dynamic> _$$BlockPersonImplToJson(_$BlockPersonImpl instance) => <String, dynamic>{'person_id': instance.personId, 'block': instance.block, 'auth': instance.auth};
...
Map<String, dynamic> _$$GetReportCountImplToJson(_$GetReportCountImpl instance) => <String, dynamic>{if (instance.communityId case final value?) 'community_id': value, 'auth': instance.auth};
...
Map<String, dynamic> _$$GetBannedPersonsImplToJson(_$GetBannedPersonsImpl instance) => <String, dynamic>{'auth': instance.auth};
